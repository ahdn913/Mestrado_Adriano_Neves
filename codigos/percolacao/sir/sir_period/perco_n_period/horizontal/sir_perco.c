// gcc sir_perco.c -O3 -Wall -lgsl -lgslcblas -lm -o sir_perco
// execução: ./sir_perco
// for I in $(seq 10000); do echo $I; ./sir_perco $I ;done
// grep "^1" dat/10000_30/percolacao.dat | wc -l
// argv[1] = seed
...
int main(int argc, char **argv){
	...
	for(lambda= 0.1815; lambda< 0.1816; lambda+= 0.006){
		ic(phi);
		cont_inf= 1;
		op(0);
		pr_int= lambda*10000;
